...
% Demo script for Nearest Neighbour classification

% Step 1: Load all the test images in the matrix
...
for i = 1 : 500
    ...
    % Split the file so that each image takes up one line in a matrix
    [r1, c1] = size(I);
    for j = 1 : r1
        image_row = I(j,:);
        data = [data, image_row];
